    ...
    <VCard :prepend-icon="mdiIcon.mdiCash" :title="props.title || 'Pembayaran'" width="500">
      <VCardText class="pa-5">
        <VForm ref="paymentForm" lazy-validation>
          ...
          <VCombobox v-model="selectedTipe" :items="tipePayments" :return-object="true" clearable item-title="label"
            item-value="value" label="Tipe Pembayaran" variant="outlined">
          </VCombobox>
...
const tipePayments = [{ label: "cash", value: "cash", ref: false },
